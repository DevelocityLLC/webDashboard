                ...
                <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="row g-5 g-xl-8 mb-5">
                        <div class="col-xl-4">
                            ...
                            <a href="{{ route('tasks.index') }}" class="card bg-secondary hoverable card-xl-stretch mb-5 mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                    ...
                    <div class="row g-5 g-xl-8 mb-5">
                        <div class="col-xl-4">
                            <!--begin::Statistics Widget 5-->
                            <a href="{{ route('admin.requirements.index') }}" class="card bg-secondary hoverable card-xl-stretch mb-5 mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                    <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-4">
                            <!--begin::Statistics Widget 5-->
                            <a href="{{ route('compalint_general') }}" class="card bg-secondary hoverable card-xl-stretch mb-5 mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen008.svg-->
                                    <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                        ...
                        <div class="col-xl-4">
                            <!--begin::Statistics Widget 5-->
                            <a href="{{ route('compalint_task') }}" class="card bg-secondary hoverable card-xl-stretch mb-5 mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr070.svg-->
                                    <span class="svg-icon svg-icon-gray-100 svg-icon-3x ms-n1">
