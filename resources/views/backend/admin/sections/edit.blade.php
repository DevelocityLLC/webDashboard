<div class="modal fade" id="Edit{{ $section->id }}" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                ...
                <form action="{{ route('sections.update' , $section->id) }}" class="form" method="POST">
                   @method('PUT')
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ __('admin.edit_section') }}</h1>
                        <!--end::Title-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-8 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a Branches" name="branch_id">
                                <option value="{{ $section->branch_id}}">{{ $section->branch->name }}</option>
