...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('news.update' , $new->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text"  name="title" class="form-control form-control-solid" placeholder="Enter title" value="{{ old('title' , $new->title) }}" >
                    ...
                    <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <textarea name="desc" class="form-control form-control-solid"  placeholder="Enter News Desc" rows="3">{{ old('desc' , $new->desc) }}</textarea>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a NewsType" name="type_id">
                               <option value="{{ $new->type_id }}">{{ $new->newsType->title }}</option>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a branches" name="branch_id">
                                <option value="{{ $new->branch_id }}">{{ $new->branch->name }}</option>
