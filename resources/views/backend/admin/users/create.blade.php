        ...
        <form action="{{ route('users.store') }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
           ...
           <div class="row">
                ...
                <div class="d-flex col-md-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="job_title" value="{{ old('job_title') }}" class="form-control form-control-solid" placeholder="Enter Your job Title" >
           ...
           <div class="row">
                ...
                <div class="d-flex col-md-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <textarea name="job_desc" class="form-control form-control-solid"  placeholder="Enter job Desc" rows="3">{{ old('job_desc') }}</textarea>
                ...
                <div class="d-flex col-md-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <textarea name="kpis" class="form-control form-control-solid"  placeholder="Enter job Desc" rows="3">{{ old('kpis') }}</textarea>
