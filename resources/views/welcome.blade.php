			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
					...
					<a href="#" class="mb-10 pt-lg-10">
						<img alt="Logo" src="{{ asset('assets/logo-shape.svg') }}" class="h-40px mb-5" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="pt-lg-10 mb-10">
						<!--begin::Logo-->
						<h1 class="fw-bolder fs-2qx text-gray-800 mb-7">Welcome to Develocity Company</h1>
						<!--end::Logo-->
						<!--begin::Message-->
						...
						<div class="text-center">
							<a href="{{ route('login-admin') }}" class="btn btn-lg btn-primary fw-bolder">Go to Admin Panel</a>
						</div> <br><br>


                        <div class="text-center">
							<a href="{{ route('login') }}" class="btn btn-lg btn-primary fw-bolder">Go to User Panel</a>
						</div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
